  ...
  <div class="login">
    ...
    <div class="login d-flex justify-content-center">
      <div class="card mx-auto mt-5 mb-5">
        <div class="card-body">
          <h3 class="card-title mb-5">Faça seu cadastro agora mesmo!</h3>
          <div class="container">
            <div class="row">
              <form>
                ...
                <div class="form-group">
                  ...
                  <input type="text" ref="cpf" placeholder="CPF" id="cpf" class="form-control mb-3 white-text"
                    name="cpf" />
                </div>
                ...
                <div class="form-row mt-4 mb-4 text-center">
                  <div class="form-group col-md-12 d-flex justify-content-end">
                    <button class="btn btn-success mt-3">Fazer cadastro</button>
                  </div>
                </div>
